...
\title{Activity detection over flute solo performances} % Title

\author{\textsc{Juan Braga}} % Author name
...
\begin{center}
Instructor: Dr. Luiz Wagner Pereira Biscainho % Instructor/supervisor
\end{center}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=1\textwidth]{spec}
\caption{Figure caption.}
\end{center}
\end{figure}
